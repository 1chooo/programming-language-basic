Program Roots
  ! Purpose: 
  !   This program solves for the roots of a qudratic equation 
  !   of the form  A * X ** 2 + B * X + C = 0. It calculates
  !   the answers regardless of the type of roots that the 
  !   equation possesses (Fortran/2003 style).
