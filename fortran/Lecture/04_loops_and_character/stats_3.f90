program stats_3
  ...
  ! Purpose:
  !   To calculate mean and the standard 
  !   deviation of an input data set,
  !   where each input value can be
  !   positive, negative, or zero.

  implicit none

  ! Data dictionary: declare variable types,
  ...
  else              ! We will have enough date, so let's get it.
